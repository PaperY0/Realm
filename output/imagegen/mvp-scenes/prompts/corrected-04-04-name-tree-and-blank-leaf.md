...
Scene: a name tree stands beside the road; every leaf is blank and one blank leaf drifts toward the road
Main action: world guide continues at a calm walking pace
Single symbolic focus: one completely blank falling leaf
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: right-side low-detail path and sky. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
