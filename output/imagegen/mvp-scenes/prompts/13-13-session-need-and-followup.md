...
Scene: same expression place with exactly four completely blank paper choices arranged as physical story objects, never a form or chat UI
Main action: Wanxian waits without pointing aggressively
Single symbolic focus: exactly four blank paper slips
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: one side 35% low-detail conversational area. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
