...
Scene: same story lake; one folded paper boat enters thin mist and one restrained story silhouette appears far away
Main action: Wanxian releases exactly one paper boat made from the confession
Single symbolic focus: one paper boat
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left low-detail mist over water. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
