...
Scene: same seven-dock river; only the seventh dock and its aligned lighthouse lose their light while the rest remain gently ordered
Main action: Tuantuan notices the specific missing light
Single symbolic focus: one dim seventh dock and lighthouse
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right 35% low-detail dim mist. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
