...
Scene: an open picture book gently closes with completely blank cover and pages; approved story artifact appearances remain consistent
Main action: Wanxian returns from the story edge carrying the corresponding artifact
Single symbolic focus: closing blank book and one returned artifact
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 35% low-detail warm page air. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.

CHARACTER IDENTITY LOCKS
Characters: Wanxian.
Folded-page spool-seed silhouette; warm paper apricot body, dusty-violet thread, tiny olive accessory and one coral knot point. Preserve chest knot, short rear thread tail and lower-left folded page-corner mark. No ears and no human clothing.
