...
Scene: same wind-direction bridge restored with selective color; the black paper-label kite has a blank reverse and leaves a moonlight-blue kite shape in the sky
Main action: Miannian crosses the bridge carrying the kite and wearing the moon ornament again
Single symbolic focus: one moonlight-blue kite memory
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right 35% low-detail sky. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
