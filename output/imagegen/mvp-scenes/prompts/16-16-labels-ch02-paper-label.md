...
Scene: same grass-world continuity; one blank dark paper label falls beside Miannian; surrounding attention is shown only through subtle directional relationships, no judging crowd
Main action: Miannian pauses and looks toward the blank label
Single symbolic focus: one completely blank dark paper label
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 35% low-detail air. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
