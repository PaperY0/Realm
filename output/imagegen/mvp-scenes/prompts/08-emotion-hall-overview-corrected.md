...
Scene: same hall with exactly five distinct emotion doors; only the inner-consumption door is open and visually emphasized
Main action: world guide remains secondary at the side
Single symbolic focus: five doors, one open inner-consumption door
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-center soft hall wall for copy. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.

CHARACTER IDENTITY LOCKS
Characters: world guide and distant five guardians.
Preserve the cream rounded body, tiny dot eyes, very small mouth, green diagonal strap and fixed small green satchel. No ears, wings, clothing redesign or animal reinterpretation. Keep all guardians subordinate and consistent with the guardian family anchor.
...
USER WORLD-GUIDE AUTHORITY AND HALL CONTINUITY
The third input is the exact world-guide IP turnaround. Preserve its two tall triangular top points, cream pear body, dot eyes, tiny mouth, U-shaped arms, tiny feet, olive diagonal strap and fixed satchel. The guide is small and secondary at the side.
Use the first input as the exact emotion-hall location. Expand it into a readable overview of exactly five distinct doors. Keep the hall intimate and hand-painted. Only the inner-consumption door associated with Wanxian and dusty-violet thread is open with restrained focal contrast. The other four doors stay closed, quiet and subordinate. No text, no human traveler, no game portal, no magic circle.
