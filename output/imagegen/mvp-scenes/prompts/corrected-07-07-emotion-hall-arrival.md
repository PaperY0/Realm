...
Scene: the emotion hall grows from distant view to a readable middle view at the end of the road
Main action: world guide reaches the entrance side and turns toward the traveler for handoff
Single symbolic focus: emotion hall threshold
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left low-detail hall air and wall. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
