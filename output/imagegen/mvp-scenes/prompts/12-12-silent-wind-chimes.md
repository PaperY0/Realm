...
Scene: silent wind-chime expression entrance in the same inner world
Main action: Wanxian quietly invites beside the chimes
Single symbolic focus: one set of silent wind chimes
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: right or center 35% low-detail mist/wall input area. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
