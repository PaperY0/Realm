...
Scene: all seven docks remain visible in the same order; repeated checking is conveyed by Tuantuan's path and posture, never cloned characters
Main action: Tuantuan looks back across the seven docks
Single symbolic focus: seven docks and one continuous checking path
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 30% low-detail mist. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
