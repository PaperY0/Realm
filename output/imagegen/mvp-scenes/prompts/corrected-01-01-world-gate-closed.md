...
Scene: closed fairy-tale world gate with a clearly readable handle; no broad light leaking from behind
Main action: world guide waits quietly beside the gate
Single symbolic focus: closed gate and readable handle
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: left or upper-left 30% low-detail sky/grass for entrance copy. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
