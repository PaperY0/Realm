...
Scene: same label alley deepens gently without cinematic perspective; several blank paper labels hang from Miannian
Main action: Miannian walks farther in the wrong direction with restrained posture
Single symbolic focus: increasing blank labels
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right 30% low-detail wall/air. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
