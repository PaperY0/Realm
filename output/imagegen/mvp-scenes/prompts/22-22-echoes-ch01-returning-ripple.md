...
Scene: quiet river world with seven small docks in a stable spatial order and one distant lighthouse across the water
Main action: Tuantuan notices one ripple returning instead of traveling forward
Single symbolic focus: one returning ripple
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 35% low-detail river mist. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
