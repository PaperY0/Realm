...
Scene: same inner world and echo shelf with completed blank book spines, two stored artifacts, a distant moonlight-blue kite and the seventh-dock warm light
Main action: Wanxian quietly stands near the revisitable shelf
Single symbolic focus: blank books, two artifacts, blue kite, seventh-dock light
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 35% low-detail shelf wall/air. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
