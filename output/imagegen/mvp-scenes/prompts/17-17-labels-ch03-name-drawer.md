...
Scene: label alley with one simple name drawer, all surfaces blank
Main action: Miannian places the moon ornament into the open drawer
Single symbolic focus: moon ornament entering one blank drawer
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: right-side 35% low-detail alley wall. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
