...
Scene: one coherent intimate inner world where silent wind chimes, story lake, artifact tree and echo shelf can all be recognized without becoming a game map
Main action: Wanxian leads along one continuous gentle path
Single symbolic focus: four connected landmarks in one quiet world
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right calm sky/mist for copy. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
