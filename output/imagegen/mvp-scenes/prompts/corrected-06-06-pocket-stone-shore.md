...
Scene: quiet pocket-stone shore beside the same route; exactly five separate stones carry only simple pictorial marks
Main action: world guide pauses near the stones
Single symbolic focus: five symbols only: star, raindrop, blue line, paper boat, leaf
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right low-detail water and sky. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
