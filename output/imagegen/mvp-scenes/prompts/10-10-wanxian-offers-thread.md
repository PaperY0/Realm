...
Scene: same door opened by only a narrow seam of warm light
Main action: Wanxian offers the thread, walks along it into the doorway and looks back waiting
Single symbolic focus: one continuous guiding thread and one door-seam light
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left low-detail hall wall. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
