...
Scene: same dock and lighthouse positions; the seventh dock and lighthouse restore exactly one warm lamp
Main action: Tuantuan wears the same small silver-fish pin and looks across the river
Single symbolic focus: same silver-fish pin and one restored warm light
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right 35% low-detail sky/mist. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.

CHARACTER IDENTITY LOCKS
Characters: Tuantuan.
Original small hedgehog with a compact warm-cream face and belly, soft chestnut scalloped quill mass, low face placement, tiny dot eyes and fixed muted-blue-gray satchel. No plush texture, anime eyes or realistic spines.
