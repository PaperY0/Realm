...
Scene: same inner-consumption door area
Main action: Wanxian hides the chest knot behind the body while exactly one thread end remains visible; guide recedes
Single symbolic focus: single visible thread end
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-right low-detail hall wall. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.

CHARACTER IDENTITY LOCKS
Characters: Wanxian and secondary world guide.
Folded-page spool-seed silhouette; warm paper apricot body, dusty-violet thread, tiny olive accessory and one coral knot point. Preserve chest knot, short rear thread tail and lower-left folded page-corner mark. No ears and no human clothing. Preserve the cream rounded body, tiny dot eyes, very small mouth, green diagonal strap and fixed small green satchel. No ears, wings, clothing redesign or animal reinterpretation.
