...
Scene: gentle grass slope in the labels story; a tiny local breeze or flower anomaly appears once
Main action: Miannian pins the fixed moon ornament beside the horn
Single symbolic focus: moon ornament and one small anomaly
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: right-side 35% low-detail sky/page air. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
