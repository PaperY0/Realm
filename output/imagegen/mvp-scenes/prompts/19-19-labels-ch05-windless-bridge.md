...
Scene: same wind-direction bridge and distant grass slope lose only part of their color; labels hang vertically because the wind has stopped
Main action: Miannian stops on the windless bridge
Single symbolic focus: still labels and partially muted bridge
Show one main action, one restrained emotion and one symbolic event only.

COMPOSITION AND FRONTEND SAFE AREA
Canvas is 16:9 landscape. Keep all essential subjects outside the outer 5% crop zone. Character height is normally 20% to 35% of frame height. Required frontend-safe region: upper-left 35% low-detail pale sky. Build this region naturally from sky, mist, water, warm page air, grass or a quiet wall, never a blank UI rectangle. Magic occupies no more than roughly 10% to 15% of the image.
